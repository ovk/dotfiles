...
# Generated from https://github.com/nordtheme/dircolors/blob/develop/src/dir_colors
...
# Start Hyprland session from UWSM
if type -q uwsm
    if status is-login; and not set -q SSH_TTY; and test (tty) = /dev/tty1
